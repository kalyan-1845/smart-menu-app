...
const Register = () => {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      // Create Account
      const res = await axios.post("http://mongodb+srv://axios.post("https://smart-menu-backend-5ge7.onrender.com/api/auth/login", { ... })_db_user:vasudev1972@cluster0.phbbtix.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0/api/auth/register", {
        username,
        password
      });
