...
const SuperAdmin = () => {
    ...
    const fetchOwners = async () => {
        setLoading(true);
        try {
            const res = await axios.get("http://mongodb+srv://axios.post("https://smart-menu-backend-5ge7.onrender.com/api/auth/login", { ... })_db_user:vasudev1972@cluster0.phbbtix.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0/api/auth/admin/all-owners");
            setOwners(res.data);
        } catch (error) {
    ...
    const toggleStatus = async (id, currentStatus, username) => {
        ...
        try {
            await axios.put(`http://mongodb+srv://axios.post("https://smart-menu-backend-5ge7.onrender.com/api/auth/login", { ... })_db_user:vasudev1972@cluster0.phbbtix.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0/api/auth/admin/update-status/${id}`, { status: newStatus });
    ...
    const handleDelete = async (id, username) => {
        ...
        try {
            await axios.delete(`http://mongodb+srv://axios.post("https://smart-menu-backend-5ge7.onrender.com/api/auth/login", { ... })_db_user:vasudev1972@cluster0.phbbtix.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0/api/auth/admin/delete-owner/${id}`);
