...
// --- PAGES (Ensure Casing matches your src/pages folder exactly) ---
...
/**
 * ✅ GLOBAL STYLES 
 * Fixes "GlobalStyles is not defined" by declaring it locally.
 * This handles the dark theme and scrollbars system-wide.
 */
const GlobalStyles = () => (
  <style>{`
    ...
    * { box-sizing: border-box; -webkit-tap-highlight-color: transparent; }
    ...
    /* Thermal Receipt Container (Hidden on UI) */
