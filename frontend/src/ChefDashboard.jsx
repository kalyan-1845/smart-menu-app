...
const ChefDashboard = () => {
    ...
    useEffect(() => {
        ...
        // Initialize Socket
        socketRef.current = io("http://mongodb+srv://prsnlkalyan_db_user:vasudev1972@cluster0.phbbtix.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0");
    ...
    const updateOrderStatus = async (orderId, newStatus) => {
        try {
            ...
            await axios.put(`http://mongodb+srv://prsnlkalyan_db_user:vasudev1972@cluster0.phbbtix.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0/api/orders/${orderId}`, { status: newStatus }, { headers: { Authorization: `Bearer ${token}` } });
    ...
    const handleDeleteOrder = async (orderId) => {
        ...
        try { 
            await axios.delete(`http://mongodb+srv://prsnlkalyan_db_user:vasudev1972@cluster0.phbbtix.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0/api/orders/${orderId}`, { headers: { Authorization: `Bearer ${token}` } }); 
