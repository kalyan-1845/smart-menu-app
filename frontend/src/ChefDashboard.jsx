...
const ChefDashboard = () => {
    ...
    const updateOrderStatus = async (orderId, newStatus) => {
        try {
            ...
            await axios.put(`https://smart-menu-backend-5ge7.onrender.com/api/orders/${orderId}`, { status: newStatus }, { headers: { Authorization: `Bearer ${token}` } });
    ...
    const handleDeleteOrder = async (orderId) => {
        ...
        try { 
            await axios.delete(`https://smart-menu-backend-5ge7.onrender.com/api/orders/${orderId}`, { headers: { Authorization: `Bearer ${token}` } }); 
