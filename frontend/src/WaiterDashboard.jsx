...
const WaiterDashboard = () => {
    ...
    useEffect(() => {
        fetchOrders();
        const socket = io("http://mongodb+srv://axios.post("https://smart-menu-backend-5ge7.onrender.com/api/auth/login", { ... })_db_user:vasudev1972@cluster0.phbbtix.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0");
    ...
    const markServed = async (id) => {
        try {
            ...
            await axios.put(`http://mongodb+srv://axios.post("https://smart-menu-backend-5ge7.onrender.com/api/auth/login", { ... })_db_user:vasudev1972@cluster0.phbbtix.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0/api/orders/${id}`, { status: "SERVED" }, { headers: { Authorization: `Bearer ${token}` } });
    ...
    const markPaid = async (id) => {
        try {
            await axios.put(`http://mongodb+srv://axios.post("https://smart-menu-backend-5ge7.onrender.com/api/auth/login", { ... })_db_user:vasudev1972@cluster0.phbbtix.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0/api/orders/${id}`, { status: "Paid" }, { headers: { Authorization: `Bearer ${token}` } });
            fetchOrders();
