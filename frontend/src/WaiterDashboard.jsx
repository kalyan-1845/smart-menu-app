...
const WaiterDashboard = () => {
    ...
    const markServed = async (id) => {
        try {
            ...
            await axios.put(`https://smart-menu-backend-5ge7.onrender.com/api/orders/${id}`, { status: "SERVED" }, { headers: { Authorization: `Bearer ${token}` } });
    ...
    const markPaid = async (id) => {
        try {
            await axios.put(`https://smart-menu-backend-5ge7.onrender.com/api/orders/${id}`, { status: "Paid" }, { headers: { Authorization: `Bearer ${token}` } });
            fetchOrders();
