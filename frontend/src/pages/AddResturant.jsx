...
const AddRestaurant = ({ onClose, refreshList }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            // ✅ UPDATED ENDPOINT: Use the superadmin route I wrote in File 1
            const res = await axios.post("https://smart-menu-backend-5ge7.onrender.com/api/superadmin/register", formData);
                    ...
                    <div style={styles.inputGroup}>
                        ...
                        <div style={{ display: 'flex', gap: '10px' }}>
                            <div style={{ position: 'relative', flex: 1 }}>
                                <input style={{...styles.input, width: '100%'}} type={showPassword ? "text" : "password"} placeholder="Click Generate" value={formData.password} onChange={e => setFormData({...formData, password: e.target.value})} required />
