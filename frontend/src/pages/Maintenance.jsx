...
const styles = {
  container: { height: "100vh", background: "#050505", color: "#fff", display: "flex", justifyContent: "center", alignItems: "center", fontFamily: "'Inter', sans-serif", textAlign: "center", padding: "20px" },
  content: { maxWidth: "450px" },
  iconWrapper: { marginBottom: "30px" },
  brand: { fontSize: "14px", fontWeight: "900", color: "#444", marginBottom: "20px", display: "flex", alignItems: "center", justifyContent: "center", gap: "8px", letterSpacing: "2px" },
  ...
  timeBox: { background: "#0a0a0a", border: "1px solid #111", padding: "15px 25px", borderRadius: "15px", display: "inline-flex", alignItems: "center", gap: "10px", fontSize: "13px", fontWeight: "700" },
