        ...
        <div style={styles.container}>
            ...
            <div style={styles.grid}>
                {filteredDishes.length === 0 ? (
                    <div style={styles.empty}><p>No dishes found.</p></div>
                ) : (
...
const styles = {
    ...
    restName: { fontSize: "24px", fontWeight: "900", margin: "0 0 4px 0", textTransform: "uppercase", color: "#fff" },
    ...
    card: { background: "#18181b", borderRadius: "16px", overflow: "hidden", border: "1px solid #27272a", display: 'flex', flexDirection: 'row', height: '130px' },
